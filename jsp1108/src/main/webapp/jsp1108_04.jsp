...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<body>
			...
			Statement stmt = null;
			ResultSet rs = null;
			int bno=0,salary=0,bhit=0;
			String btitle,bdate,id;
			int i= 0;
			...
			try{ 	
				  ...
				  String query = "select * from ( select row_number() over(order by bgroup desc,bstep asc) rnum, a.* from board a where btitle like '%ia%' ) where rnum>=1 and rnum<=5";
