					...
					<div class="informbox">
						<div class="inform">
							<ul>
								...
								<li><input type="password" name="pw" id="id" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
